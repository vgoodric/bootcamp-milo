...
const { default: init } = await import('../../../libs/blocks/newsletter-modal/newsletter-modal.js');
...
describe('newsletter modal block', () => {
  ...
  it('should initialize the newsletter modal block', () => {
  ...
  it('does not submit form when email is not valid', () => {
    const block = document.querySelector('.newsletter-modal');
    init(block);
